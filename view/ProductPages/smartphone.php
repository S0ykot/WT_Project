...
<body>
									...
									<nav id="menuContainer">
										<menu id="listContainer">
											<ul id="lists">
												...
												<li><a href="lifestyle.php">Lifestyle</a></li>											</ul>
										</menu>
									</nav>
								</div>
							</td>
						...
						<tr>
							...
							<td>
								<table border="1px" width="100%" cellpadding="0px" cellspacing="0px">
									<tr>
										<td width="20%" align="center"> <img src="../Images/mobileLense.jpg" alt="" height="125px" width="100px"><br><br>
											<br><br><hr width="120px">Smartphone Camera Lense 	<br>2000tk <br><br> Available</td>
										<td width="20%" align="center"> <img src="../Images/mobileLense.jpg" alt="" height="125px" width="100px"><br><br>
											<br><br><hr width="120px">Smartphone Camera Lense		<br>2000tk <br><br> Available</td>
										<td width="20%" align="center"> <img src="../Images/mobileLense.jpg" alt="" height="125px" width="100px"><br><br>
											<br><br><hr width="120px">Smartphone Camera Lense		<br>2000tk <br><br> Available</td>
					...
					<table border="0px" width="100%" cellpadding="0px" cellspacing="0px" align="center">
						<tr>
							<td valign="middle" width="49%" align="center"><img src="Images/shopnow.png" alt="" height="100px" width="50%"></td>
						</tr>
					</table>
					<table>
						<tr><hr></tr>
