									...
									<tr>
										<td>
												<table border="0px" width="100%" cellpadding="0px" cellspacing="0px">
													...
													<tr>
														<th height="30%" align="center"><h2><div class="header">Payment Methode</div></h2></th>
													</tr>
													<tr>
														<div ><td align="center" height="70px"><div id="method"><input type="radio" name="payment" value="CashOnDelivery">Cash On Delivery&emsp;&emsp;<input type="radio" name="payment" value="bKash">bKash</td></div>
													</tr>
													<tr>
														
															<td align="center" valign="bottom" height="20px">
																<input type="submit" id="loginRegBtn" id="addCartBtn" name="savepass" value="Checkout" onclick="order()"><br><br>
															</td>
													</tr>
