						...
						<tr>
							...
							<td bgcolor="">
								<form action="../../php/checkUpdate.php" method="post">
									...
									<tr>
										<td bgcolor="#E8EBEC">&emsp;<input type="text" name="nameInfo" value="<?= $_SESSION['NAME']?>"></td>
									</tr>
									<tr>
										<td bgcolor="#E8EBEC">
									...
									<tr>
										<td bgcolor="#E8EBEC">&emsp;<input type="text" name="emailInfo" value="<?= $_SESSION['EMAIL']?>"></td>
									</tr>
									...
									<tr>
										<td bgcolor="#E8EBEC">&emsp;<input type="text" name="conInfo" value="<?= $_SESSION['CONTACT']?>"></td>
									</tr>
									<tr><td height="20px" bgcolor="#E8EBEC"></td></tr>
									...
									<tr>
										<td bgcolor="#E8EBEC">
											&emsp;<input type="submit" name="save" value="Save">
										</td>
									</tr>
